...
<section class="featured-project">
	<h3>Featured: redis-from-scratch</h3>
	<p>
		Built a Redis-compatible in-memory key-value store in Go with RESP3 support and Pub-Sub,
		then used it as the backing store for a REST API-based Kafka clone to validate correctness
		under real integration pressure.
	</p>
	<div class="project-links">
		<a href="https://github.com/snigenigmatic/redis-from-scratch" target="_blank" rel="noopener">View repository</a>
